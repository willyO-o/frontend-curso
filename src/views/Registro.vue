...
onMounted(() =>{
    ...
    console.log(usuarioStore.accessToken)
})
                ...
                <div class="col-lg-7 col-md-9">
                    <div class="auth-card anim scale-in">
                        ...
                        <div class="auth-card-body">
                            <Form :validation-schema="registroValidationSchema" @submit="procesarRegistro"
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <Field type="text" v-model="datosUsuario.name"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <Field type="email" v-model="datosUsuario.email" class="form-control" id="email" name="email"
                                            placeholder="por ejemplo: usuario@ejemplo.com"
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            class="form-control"
                                                id="password" placeholder="Create password" name="password"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="fas fa-lock"></i></span>
                                            <Field :type="mostrarPassword ? 'text' : 'password'" 
                                            v-model="datosUsuario.password_confirm"
                                            ...
                                            <button @click="mostrarPassword = !mostrarPassword"
                                                class="btn btn-toggle-password" type="button"
                                                "><i
                                                    :class="{ 'fas fa-eye': !mostrarPassword, 'fas fa-eye-slash': mostrarPassword }"></i></button>
                                        </div>
                            ...
                            <p class="auth-footer-text">Ya tienes una cuenta? <RouterLink to="/login">Inicia sesión aquí</RouterLink></p>
                        </div>
                    </div>
                </div>
            </div>
